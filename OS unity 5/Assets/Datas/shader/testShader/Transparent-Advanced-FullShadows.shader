...
{ 
	...
	_ShadowBlur ("Shadow blur", Range (0, 1)) = 0.6
} 
...
c.a += tex2D(_MainTex, float2(i.uv.x - 5.0 * _ShadowBlur, i.uv.y - 5.0 )) * 0.025;
c.a += tex2D(_MainTex, float2(i.uv.x - 4.0 * _ShadowBlur, i.uv.y - 4.0 )) * 0.05;
c.a += tex2D(_MainTex, float2(i.uv.x - 3.0 * _ShadowBlur, i.uv.y - 3.0 )) * 0.09;
c.a += tex2D(_MainTex, float2(i.uv.x - 2.0 * _ShadowBlur, i.uv.y - 2.0 )) * 0.12;
c.a += tex2D(_MainTex, float2(i.uv.x - 1.0 * _ShadowBlur, i.uv.y - 1.0 )) * 0.15;
c.a += tex2D(_MainTex, float2(i.uv.x, i.uv.y)) * 0.16;
c.a += tex2D(_MainTex, float2(i.uv.x + 1.0 * _ShadowBlur, i.uv.y + 1.0 )) * 0.15;
c.a += tex2D(_MainTex, float2(i.uv.x + 2.0 * _ShadowBlur, i.uv.y + 2.0 )) * 0.12;
c.a += tex2D(_MainTex, float2(i.uv.x + 3.0 * _ShadowBlur, i.uv.y + 3.0 )) * 0.09;
c.a += tex2D(_MainTex, float2(i.uv.x + 4.0 * _ShadowBlur, i.uv.y + 4.0 )) * 0.05;
