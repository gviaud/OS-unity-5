...
public class HSVPicker : MonoBehaviour {
	...
	public Color32 currentPlageColor;
	public Color32 currentMargelleColor;
	public Color32 currentMuretColor;
    ...
    void Awake()
    {
		...
		sliderPicker.SetSliderPosition(1f);
    ...
    public Color MovePointer(float newPos, bool updateInputs = true)
    {
		...
		Color mainColor =((Texture2D)(hsvSlider.texture)).GetPixelBilinear(0f, pointerPos);
