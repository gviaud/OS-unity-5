...
public class Function_Murret : MonoBehaviour, Function_OS3D
{

    //tableaux de gameobject bougeant tous selon la même dirrction et le même sens
    ...
    //Paramètre de scale initiaux, utilisés pour la copie et la sauvegarde
    ...
    /// <summary>
    /// Bouge tout les Vertices d'un mesh à la position indiqué
    /// </summary>
    public static void moveMesh(Mesh m, Vector3 delta){
    ...
    /// <summary>
    /// Redimensionnement du mesh par addition
    /// </summary>
    public static void addSizeToMesh(Mesh m, Vector3 size)
    {
    ...
    void Start()
    {
        if (root == null)
        {
            ...
            m_skinInter = GameObject.Find("MainScene").GetComponent<GUIMenuInteraction>().skin;
            ...
            //parsing du nom de chaque gameObject pour le placer dans le bon tableau
        ...
        //Création de gameObjects qui vont être les parents des groupes d'objets ayant un comportement similaire
        ...
        //On récupère la taille initiale selon chaque axe pour un changement de tiling de la texture efficasse
        ...
        //Initialisation de la taille initiale passé dans xScale, yScale et zScale
    ...
    void Scale(float x, float y, float z)
    {
        ...
        if (x != 0f)
        {
            ...
            {
                string name = child.name.ToLower();
                //Scale des objets à scaler sur x
            ...
            //Mouvements des objets à bouger
