...
public class Function_Animation2 : MonoBehaviour, Function_OS3D {
	
	public string _functionName = "ReglageVolet";
	
	public string _animName = "Take 001";
	
	public string _uiName;	
	protected FunctionUI_OS3D _ui;
	
	public float vValue=0.0f;
	...
	void Awake ()
	{
		...
		_controller.SetPoolObject(transform, _animName);
		_controller.SetValue(vValue);
		//if(_controller!=null)
