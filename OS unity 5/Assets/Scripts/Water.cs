...
public class Water : MonoBehaviour
{
	...
	private LightConfiguration mainLightConfiguration;
...
float LTwaveScale  = 5;
	...
	float initWave		=	-1.0f;
	/*float initRefrac	=	-1.0f;
	float initReflect	=	-1.0f;*/
	...
	public void OnWillRenderObject()
	{
		...
		if( mode >= WaterMode.Refractive )
		{
			...
			//refractionCamera.transform.position = new Vector3(0, 20, 0);
			
			///refractionCamera.depthTextureMode = DepthTextureMode.Depth;
			
			refractionCamera.transform.rotation = cam.transform.rotation;
			//refractionCamera.transform.eulerAngles = new Vector3(90, 0, 0);
...
/*void OnDrawGizmosSelected() {
		...
		Gizmos.DrawWireCube(Camera.current.transform.position, 
